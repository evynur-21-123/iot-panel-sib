...
// 1. URL   -> http://127.0.0.1:8000/api/api/temperature
// 2. Lokasi file controller -> []
Route::get('api/temperature', [TemperatureController::class, 'getTemperature']);
Route::post('api/temperature', [TemperatureController::class, 'insertTemperature']);